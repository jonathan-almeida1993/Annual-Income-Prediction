...
def perceptron_test(weight_vector_final,bias_final):
	...
	for line in test_data:
			...
			count += 1;
	test_data.close();
	accuracy = float(count_success)/float(count)
	return accuracy
...
def test_it():
	...
	weight_vector_final,bias_final = perceptron(5);
	print("\nTesting on the data set...")
	accuracy = perceptron_test(weight_vector_final,bias_final);
	print("Accuracy of Perceptron = %f"%accuracy)
	file.close();
	json_file.close();
